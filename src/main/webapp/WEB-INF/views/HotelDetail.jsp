...
<body>
	...
	<div style="font-size: 12px;">
		<div id="hc_htl_desc">
			<strong>제주 신라 호텔 - &lt;5성급&gt; - </strong><br> 해변가가 내려다보이는 쉬리의
			언덕이 유명한 제주 신라 호텔은 중문관광단지 내 자리하고 있어 여미지식물원, 천제연폭포, 별내린 전망대 등이 아주 가까운
			거리에 있습니다.<br> 또한, 제주국제공항은 차로 1시간 5분 거리에 있으며 1일 3회 호텔-공항 간 무료 셔틀을
			운영하고 있습니다.<br> 호텔 내에 여유롭게 산책을 즐기기에 좋은 숨비정원이 있으며 사전 예약을 하시면 캠핑과
			글램핑도 즐기실 수 있습니다. 또한, 짐보리클럽, 키즈아일랜드 등 아이들을 위한 <br> 다양한 시설이 완비되어
			있으며 플레이스테이션 전 기종을 체험해볼 수 있는 플레이스테이션 존도 있습니다. 그 외에도 피트니스센터, 스파, 사우나,
			미팅룸 등을 이용<br> 하실 수 있으며 기념품샵과 특산물 매장에서 쇼핑을 즐기실 수도 있습니다.38개의 스위트
			객실을 포함한 429개 객실을 보유하고 있으며 객실에 따라 한라산 또는 바다를 감상하실 수 있습니다<br> 또한,
			모든 객실에 TV, 냉장고, 에어컨, 금고 등이 완비되어 있으며 욕실에는 욕실용품, 비데, 헤어드라이어 등이 있습니다. 호텔
			내에 있는 한식, 일식, 뷔페 레스토랑이 있으며 <br>조식은 뷔페 레스토랑 파크뷰와 한식당인 천지에서 제공하고
			있으며 별도의 요금이 발생합니다. 그 밖에도 로비 라운지와 풀사이드바를 운영하고 있습니다.
		</div>

		<div id="hc_htl_grade">
			5성급 호텔입니다. <span id="hc_htl_star"> ★★★★★ </span>
		</div>
